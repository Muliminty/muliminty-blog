...
Clone the [Muliminty Blog. repository](https://github.com/trevortylerlee/astro-micro.git).
...
export const SITE: Site = {
  NAME: "Muliminty Blog.",
  DESCRIPTION: "Muliminty Blog. is an accessible theme for Astro.",
...
export const ABOUT: Metadata = {
  TITLE: "About",
  DESCRIPTION: "Muliminty Blog. is a fork of Astro Nano.",
};
```
